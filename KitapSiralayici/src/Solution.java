...
import java.util.TreeSet;
    ...
    public class Solution {
        public static void main(String[] args) {
            ...
            for (Book book : books) {
                System.out.println(String.format("Kitap adi : %s \nSayfa sayisi : %s \nYazar : %s \nYayim Tarihi : %s", book.getName(), book.getPage(), book.getAuthor(), book.getReleaseYear()));
            }
            ...
            for (Book kitap : book) {
                System.out.println(String.format("Kitap adı : %s \nSayfa sayısı : %s \nYazar : %s \nYayım tarihi : %s",kitap.getName(),kitap.getPage(),kitap.getAuthor(),kitap.getReleaseYear()));
            }
        }
    }
